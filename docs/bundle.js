            ...
            value: function(e, t) {
              ...
              null !== l
                ? i > this._maxLength
                  ...
                  ? (3 !== i && 6 !== i) || !p(l)
                    ? p(l)
                      ? ((f = o.substr(0, i - 1) + l + o.substr(i + 1)), (2 !== i && 5 !== i) || (d = i + 1))
                      : (d = i - 1)
                    : ((f = '' + o.substr(0, i - 1) + s + l + o.substr(i + 2)), (d = i + 1))
                  : (f = '' + o.substr(0, i - 1) + s + o.substr(i + 1))
                : null !== c &&
                  ((2 !== i && 5 !== i) || c !== s
                    ? (f = o.substr(0, i) + '0' + o.substr(i))
                    : ((f = o.substr(0, i - 1) + '0' + s + o.substr(i)), (d = i - 1)));
              var h = m(this._showSeconds, f, n, this._colon, d),
                v = a(h, 2),
                y = v[0],
                g = v[1];
              this.setState({value: y}, function() {
                (r.selectionStart = g), (r.selectionEnd = g), t(y);
              }),
                e.persist();
            }
          },
